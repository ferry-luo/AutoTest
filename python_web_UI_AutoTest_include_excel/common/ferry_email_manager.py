...
class EmailManager:
    ...
    def ferry_send_email(self, report_file):
        ...
        content_text = '''
                    ...
                    <p style="text-indent:2em;font-family:新宋体;font-size:18px">附件为XXX项目_web自动化测试报告，请查阅，谢谢！</p>
        ...
        att_file.add_header('Content-Disposition', 'attachment',
                            filename='XXX项目_web自动化测试报告.html')  # 设定收件人下载这个附件的时候默认文件名，这个随便你怎么定
